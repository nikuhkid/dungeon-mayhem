...
export const CARDS = {
  ...
  // 5+2+2+2+1+2+2+1+1+1+1+2+2+2+2 = 28
  // =============================================
  ...
  sutha_battle_roar: {
    ...
    description: 'Deal 1 damage and heal 1 HP',
  },
  sutha_whirling_axes: {
    id: 'sutha_whirling_axes', heroId: 'sutha', name: 'Whirling Axes', count: 2,
    symbols: [atk(1, 'all_opponents'), drw(1)],
    description: 'Deal 1 damage to all opponents, draw 1 card',
  },
  sutha_flex: {
  ...
  sutha_snack_time: {
    ...
    symbols: [heal(2), drw(1)],
    description: 'Heal 2 HP and draw 1 card',
  },
  sutha_open_armory: {
  ...
  sutha_two_axes: {
    ...
    symbols: [atk(2), again()],
    description: 'Deal 2 damage and play again',
  },
  sutha_raff: {
    id: 'sutha_raff', heroId: 'sutha', name: 'Raff', count: 1,
    symbols: [sld(2)],
    description: 'Raff defends you: gain 2 shields',
  },
  sutha_riff: {
    id: 'sutha_riff', heroId: 'sutha', name: 'Riff', count: 1,
    symbols: [sld(2)],
    description: 'Riff defends you: gain 2 shields',
  },
  sutha_spiked_shield: {
    id: 'sutha_spiked_shield', heroId: 'sutha', name: 'Spiked Shield', count: 1,
    symbols: [sld(2), atk(1)],
    description: 'Gain 2 shields and deal 1 damage to one opponent',
  },
  sutha_bag_of_rats: {
    id: 'sutha_bag_of_rats', heroId: 'sutha', name: 'Bag of Rats', count: 1,
    symbols: [atk(1, 'all_opponents')],
    description: 'Release the rats — deal 1 damage to all opponents',
  },
  sutha_rage: {
  ...
  sutha_brutal_punch: {
    ...
    symbols: [atk(2), sld(1)],
    description: 'Deal 2 damage and gain 1 shield',
  },
  sutha_head_butt: {
  ...
  sutha_mighty_toss: {
    ...
    symbols: [mty('mighty_strike', { value: 5, target: 'opponent' })],
    description: 'Hurl something enormous — deal 5 damage to one opponent',
  },
  ...
  azzan_speed_of_thought: {
    ...
    symbols: [drw(1), again()],
    description: 'Draw 1 card and play again',
  },
  azzan_mirror_image: {
    id: 'azzan_mirror_image', heroId: 'azzan', name: 'Mirror Image', count: 1,
    symbols: [sld(3), again()],
    description: 'Gain 3 shields and play again',
  },
  azzan_fireball: {
  ...
  azzan_charm: {
    ...
    description: "Steal a card from an opponent's hand and play it",
  },
  azzan_shield: {
  ...
  lia_fluffy: {
    ...
    symbols: [sld(3), heal(2)],
    description: "Fluffy protects you: gain 3 shields and heal 2 HP",
  },
  lia_spinning_parry: {
  ...
  lia_divine_inspiration: {
    ...
    symbols: [drm()],
    description: 'Pick any card from your discard pile and add it to your hand (draw 1 if discard is empty)',
  },
  ...
  lia_high_charisma: {
    ...
    symbols: [drw(1), heal(1)],
    description: 'Draw 1 card and heal 1 HP',
  },
  lia_finger_wag: {
    id: 'lia_finger_wag', heroId: 'lia', name: 'Finger-wag of Judgement', count: 2,
    symbols: [mty('destroy_shields', { target: 'all_opponents' })],
    description: 'Destroy all shields on all opponents',
  },
  lia_banishing_smite: {
    id: 'lia_banishing_smite', heroId: 'lia', name: 'Banishing Smite', count: 1,
    symbols: [mty('destroy_shields', { target: 'all_opponents' }), again()],
    description: 'Destroy all opponent shields and play again',
  },
  ...
  oriax_pick_pocket: {
    ...
    description: "Steal the top card of an opponent's deck, resolve its effects, and return it to their discard",
  },
  ...
  minsc_favored_frienemies: {
    ...
    symbols: [atk(2), drw(1)],
    description: 'Deal 2 damage and draw 1 card',
  },
  minsc_go_for_eyes: {
    id: 'minsc_go_for_eyes', heroId: 'minsc', name: 'Go for the Eyes Boo!!!', count: 3,
    symbols: [atk(1, 'all_opponents')],
    description: 'Boo attacks: deal 1 damage to all opponents',
  },
  minsc_krydle: {
    id: 'minsc_krydle', heroId: 'minsc', name: 'Krydle and Shandie', count: 1,
    symbols: [sld(2), drw(1)],
    description: 'Companions provide cover: gain 2 shields and draw 1 card',
  },
  minsc_mighty_mount: {
    id: 'minsc_mighty_mount', heroId: 'minsc', name: "Minsc's Mighty Mount", count: 2,
    symbols: [sld(3)],
    description: 'Riding high: gain 3 shields',
  },
  minsc_wrap_it_up: {
    id: 'minsc_wrap_it_up', heroId: 'minsc', name: 'Wrap It Up', count: 1,
    symbols: [atk(4)],
    description: "That's it — deal 4 damage to one opponent",
  },
  minsc_justice: {
  ...
  minsc_scouting: {
    ...
    symbols: [drw(2)],
    description: 'Scout ahead: draw 2 cards',
  },
  minsc_nerys: {
    id: 'minsc_nerys', heroId: 'minsc', name: 'Pale Priestess Nerys', count: 2,
    symbols: [heal(2)],
    description: 'Nerys heals you: heal 2 HP',
  },
  minsc_time_to_punch: {
    id: 'minsc_time_to_punch', heroId: 'minsc', name: 'Time to Punch Evil!', count: 1,
    symbols: [atk(2, 'all_opponents'), again()],
    description: 'Punch all evil: deal 2 damage to all opponents and play again',
  },
  minsc_hold_rodent: {
    id: 'minsc_hold_rodent', heroId: 'minsc', name: 'Someone Hold my Rodent', count: 2,
    symbols: [drw(1), again()],
    description: 'Pass Boo: draw 1 card and play again',
  },
  ...
  jaheira_gift_silvanus: {
    ...
    formDependent: true,
    bearSymbols: [sld(3), heal(2)],
    wolfSymbols: [atk(2, 'all_opponents')],
    symbols: [],
    description: 'Bear Form: gain 3 shields + heal 2 | Wolf Form: deal 2 to all opponents',
  },
  jaheira_druidic_balance: {
    id: 'jaheira_druidic_balance', heroId: 'jaheira', name: 'Druidic Balance', count: 2,
    symbols: [heal(1), sld(1)],
    description: 'Heal 1 HP and gain 1 shield',
  },
  ...
  jaheira_thorn_whip: {
    ...
    symbols: [atk(1), drw(1)],
    description: 'Deal 1 damage and draw 1 card',
  },
  jaheira_quick_fox: {
    id: 'jaheira_quick_fox', heroId: 'jaheira', name: 'Quick as a Fox', count: 2,
    symbols: [again(), drw(1)],
    description: 'Play again and draw 1 card',
  },
  jaheira_wild_rush: {
  ...
  jaheira_eldest_elk: {
    ...
    symbols: [sld(4)],
    description: 'The ancient elk protects you: gain 4 shields',
  },
  jaheira_poochie: {
    id: 'jaheira_poochie', heroId: 'jaheira', name: 'Poochie', count: 2,
    symbols: [heal(2)],
    description: 'Good dog: heal 2 HP',
  },
  jaheira_bearnard: {
    id: 'jaheira_bearnard', heroId: 'jaheira', name: 'Bearnard', count: 2,
    symbols: [sld(3)],
    description: 'Bearnard shields you: gain 3 shields',
  },
  ...
  jaheira_commune: {
    ...
    symbols: [drw(2)],
    description: 'Commune: draw 2 cards',
  },
  jaheira_wolf_form: {
    id: 'jaheira_wolf_form', heroId: 'jaheira', name: 'Shapeshift: Wolf Form', count: 3,
    symbols: [mty('set_form', { value: 'wolf', target: 'self' }), drw(1)],
    description: 'Transform into Wolf Form (aggressive) and draw 1 card',
  },
  jaheira_bear_form: {
    id: 'jaheira_bear_form', heroId: 'jaheira', name: 'Shapeshift: Bear Form', count: 2,
    symbols: [mty('set_form', { value: 'bear', target: 'self' }), sld(1)],
    description: 'Transform into Bear Form (defensive) and gain 1 shield',
  },
};
